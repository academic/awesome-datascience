...
- [OpenWaterAtlas Spot–Climate–Species–Routes Dataset](https://doi.org/10.5281/zenodo.20668393) - 2,928 named dive, kite, surf and freedive sites joined to 112,548 OBIS + GBIF marine species occurrences (within 5 km), per-spot 5-year daily climate aggregates, and 34,876 OpenFlights direct routes. CC BY 4.0, versioned Zenodo DOI, mirrored on Kaggle and Hugging Face.
