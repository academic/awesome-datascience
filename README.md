...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and x402 micropayment verification for AI agents on Solana. MCP server (zero-install, streamable-http) with tools: resolve_agent, score_agent, preflight_check, verify_trust_receipt. Also on [PyPI](https://pypi.org/project/twzrd-agent-intel/).
