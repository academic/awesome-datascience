...
- [Gumroad Digital Product Market Data](https://github.com/sujeito-operator/gumroad-market-data) - Marketplace snapshot of 8,311 Gumroad digital products from 4,532 sellers across 255 categories, with asking price, currency and rating count, plus publisher-disclosed unit sales for 316 listings (450,651 units). Four CSVs with data dictionaries, CC BY 4.0, Zenodo DOI.
