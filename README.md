...
| [AWS Rekognition](https://aws.amazon.com/rekognition) | AWS Rekognition is a service that lets developers working with Amazon Web Services add image analysis to their applications. |
