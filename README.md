...
- [ML Academy](https://mltraining.org) - 123 interactive lessons that run entirely in the browser. Algorithms implemented from scratch, and every numeric claim in the lesson text is recomputed by a test suite.
