...
- [Official Offers Dataset](https://github.com/promo2you-lab/official-offers-dataset) - Open dataset of offers that 34 consumer brands publish on their own websites, 82 rows, each with the official source URL it was read from and the date it was last checked. CSV and JSON, no login, MIT licensed.
