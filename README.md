...
| [Intellrise](https://intellrise.com) | Hosted AI data analyst for live SQL databases and warehouses — plain-English questions become schema-aware SQL you can read, with an editable semantic layer and bring-your-own-key model access. |
